...
from apps.compressor.consts import COMPRESSOR_MODE_INLINE, COMPRESSOR_MODE_LINKS, \
    COMPRESSOR_MODE_ONE_FILE, COMPRESSOR_MARKER
from apps.compressor.utils import add_to_compress
...
#check middleware
if "apps.compressor.middleware.CompressorMiddleware" not in settings.MIDDLEWARE_CLASSES:
    raise Exception("Add 'apps.compressor.middleware.CompressorMiddleware' in your settings.MIDDLEWARE_CLASSES")
